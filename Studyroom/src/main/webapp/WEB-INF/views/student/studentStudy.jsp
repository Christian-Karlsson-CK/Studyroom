	...
	<body>
		...
		<div class = "contents">
			...
			<div class="table_container">
				...
				<!-------------------------------------------------------------------------------------------------------------------------->
				<!-------------------------------------------A Courselist that display all enrolled courses for the student.---------------->
				<!------------------------------‐--‐---------------------------------------------------------------------------------------->
			...
			<div class="table_container2">
				...
				<!-------------------------------------------------------------------------------------------------------------------------->
				<!-------------------------------------------Table that displays data about the selected course----------------------------->
				<!------------------------------‐--‐---------------------------------------------------------------------------------------->
				...
				<!-------------------------------------------------------------------------------------------------------------------------->
				<!----------------Displaying exercises and ability for student to answer them and view teacher replies.‐-------------------->
				<!------------------------------‐--‐---------------------------------------------------------------------------------------->
