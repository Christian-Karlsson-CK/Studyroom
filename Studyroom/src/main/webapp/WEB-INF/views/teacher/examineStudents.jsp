...
<html>
	...
	<body>
		...
		<div class = "contents">
			...
			<!-------------------------------------------------------------------------------------------------------------------------->
			<!----------------------------------Table that displays all students that the teacher is teaching to.----------------------->
			<!------------------------------‐--‐---------------------------------------------------------------------------------------->
			...
			<!-------------------------------------------------------------------------------------------------------------------------->
			<!-----Table that display all courses the selected student is enrolled to, and that logged in teacher is teaching in.------->
			<!------------------------------‐--‐---------------------------------------------------------------------------------------->
			...
			<!-------------------------------------------------------------------------------------------------------------------------->
			<!------Form that let teacher view student answers to exercises and examinations and let teacher give a reply.-------------->
			<!------------------------------‐--‐---------------------------------------------------------------------------------------->
