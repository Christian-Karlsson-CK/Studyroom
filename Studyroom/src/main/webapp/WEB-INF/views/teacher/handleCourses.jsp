...
<html>
	...
	<body>
		...
		<div class = "contents">
			...
			<!-------------------------------------------------------------------------------------------------------------------------->
			<!-------------------------------A table displaying all courses the teacher are assigned to.-------------------------------->
			<!------------------------------‐--‐---------------------------------------------------------------------------------------->
			...
			<!-------------------------------------------------------------------------------------------------------------------------->
			<!-------------------------------------------Table showing details about selected course.----------------------------------->
			<!------------------------------‐--‐---------------------------------------------------------------------------------------->
			...
			<!-------------------------------------------------------------------------------------------------------------------------->
			<!---------------------------------Form for the exercises and examination for selected course.------------------------------>
			<!------------------------------‐--‐---------------------------------------------------------------------------------------->
